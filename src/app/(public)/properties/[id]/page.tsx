...
const getPropertyById = (id: string): Property | undefined => {
  const properties: Property[] = [
    { id: '1', title: 'Villa Moderna en Condominio Privado', price: '2,500,000', address: '123 Luxury Lane, Beverly Hills, CA', bedrooms: 5, bathrooms: 6, garage: 3, sqft: 5800, imageUrl: 'https://placehold.co/1200x800.png', description: 'Experimenta un lujo sin igual en esta impresionante villa moderna. Con un espacio de vida de concepto abierto, cocina de última generación y una impresionante piscina infinita. Ubicada en un exclusivo condominio privado, esta casa ofrece privacidad y prestigio.' },
    { id: '2', title: 'Penthouse en el Centro con Vistas a la Ciudad', price: '3,200,000', address: '456 High Rise, New York, NY', bedrooms: 3, bathrooms: 4, garage: 2, sqft: 3500, imageUrl: 'https://placehold.co/1200x800.png', description: 'Un magnífico penthouse que ofrece vistas panorámicas del horizonte de la ciudad. Con ventanas de piso a techo, una terraza privada y acabados a medida, esta residencia es el epítome de la sofisticación urbana.' },
    { id: '3', title: 'Acogedora Casa de Playa', price: '1,800,000', address: '789 Ocean Drive, Malibu, CA', bedrooms: 4, bathrooms: 3, garage: 1, sqft: 2200, imageUrl: 'https://placehold.co/1200x800.png', description: 'Encantadora y elegante casa de playa con acceso directo a la arena. Disfruta de espectaculares vistas al mar desde todas las habitaciones, una espaciosa terraza para el entretenimiento y los tranquilos sonidos de las olas.' },
    { id: '4', title: 'Rancho Extenso con Terreno', price: '4,500,000', address: '101 Country Road, Aspen, CO', bedrooms: 6, bathrooms: 7, garage: 4, sqft: 8000, imageUrl: 'https://placehold.co/1200x800.png', description: 'Un majestuoso rancho ubicado en 50 acres de tierra prístina. Esta extensa propiedad cuenta con una gran casa principal, cuartos de huéspedes e instalaciones ecuestres, todo con impresionantes fondos de montaña.' },
    { id: '5', title: 'Histórica Casa de Piedra en la Ciudad', price: '2,100,000', address: '212 City Block, Boston, MA', bedrooms: 5, bathrooms: 4, garage: 0, sqft: 3200, imageUrl: 'https://placehold.co/1200x800.png', description: 'Una casa de piedra histórica bellamente conservada que combina el carácter atemporal con las comodidades modernas. Ubicada en una pintoresca calle arbolada en el corazón de la ciudad.' },
    { id: '6', title: 'Casa Minimalista en el Desierto', price: '1,950,000', address: '321 Cactus Trail, Scottsdale, AZ', bedrooms: 3, bathrooms: 3, garage: 2, sqft: 2800, imageUrl: 'https://placehold.co/1200x800.png', description: 'Una obra maestra de diseño minimalista, esta casa en el desierto se integra a la perfección con su entorno natural. Líneas limpias, materiales naturales y un énfasis en la vida interior-exterior crean un refugio sereno.' },
  ];
            ...
            <Card className="sticky top-24">
              ...
              <CardContent>
                ...
                <div className="space-y-4 text-foreground">
                  ...
                  <div className="flex justify-between items-center"><span className="text-muted-foreground">Pies cuadrados</span> <span className="font-semibold flex items-center gap-2">{property.sqft.toLocaleString()} <Maximize size={18}/></span></div>
                </div>
