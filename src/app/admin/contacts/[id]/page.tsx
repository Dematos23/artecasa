        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                {ownedProperties.length > 0 && (
                    <Card>
                        <CardHeader>
                            <CardTitle className="font-headline text-xl flex items-center gap-2"><Home size={20} /> Propiedades en Posesión</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <ul className="space-y-3">
                                {ownedProperties.map(prop => (
                                    <li key={prop.id} className="text-sm">
                                        <Link href={`/properties/${prop.id}`} className="text-primary hover:underline font-medium">{prop.title}</Link>
                 ...
                 {interestedProperties.length > 0 && (
                    <Card>
                        <CardHeader>
                            <CardTitle className="font-headline text-xl flex items-center gap-2"><Home size={20} /> Propiedades de Interés</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <ul className="space-y-3">
