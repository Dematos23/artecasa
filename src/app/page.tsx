...
const dummyProperties: Property[] = [
  {
    id: '1',
    title: 'Modern Villa in a Gated Community',
    price: '2,500,000',
    ...
    <div className="bg-background">
      <section className="relative h-[70vh] min-h-[500px] max-h-[700px] w-full">
        <Image
          ...
          alt="Hero background image of a modern luxury home"
          layout="fill"
          objectFit="cover"
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-center text-white px-[3%] md:px-[5%] xl:px-[12%]">
          ...
          <p className="text-xl md:text-2xl max-w-3xl">Where Your Dream Home Becomes a Reality</p>
        ...
        <div className="container mx-auto px-[3%] md:px-[5%] xl:px-[12%]">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold font-headline mb-4">Featured Property</h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6 text-foreground">
                <div className="flex items-center gap-2"><BedDouble className="text-primary" /> <span>{featuredProperty.bedrooms} Beds</span></div>
                <div className="flex items-center gap-2"><Bath className="text-primary" /> <span>{featuredProperty.bathrooms} Baths</span></div>
                <div className="flex items-center gap-2"><Car className="text-primary" /> <span>{featuredProperty.garage} Garage</span></div>
              </div>
              <Button asChild>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-[3%] md:px-[5%] xl:px-[12%]">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-headline mb-4">Discover Our Properties</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A curated selection of the finest luxury homes, tailored to your lifestyle.
            </p>
          </div>
