          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-2xl md:text-3xl font-bold mb-6">{featuredProperty.currency === 'USD' ? '$' : 'S/'}{Number(featuredProperty.price).toLocaleString()}{featuredProperty.modality === 'alquiler' && ' / mes'}</p>
