...
export function PortalPropertyCard({ property }: PortalPropertyCardProps) {
  ...
  useEffect(() => {
    async function fetchSettingsData() {
        // For portal cards, we can fetch the specific tenant's settings
        // if we want to show their branding, or use a global default.
        // Let's fetch tenant-specific for now if tenantId exists.
  ...
  // The URL on the portal needs to identify both the tenant and the property.
